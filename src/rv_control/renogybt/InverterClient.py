...
class InverterClient(BaseClient):
    def __init__(self, config: Any, on_data_callback: Any = None, on_error_callback: Any = None) -> None:
        """Initialize the inverter client and register parser definitions."""
    ...
    def parse_inverter_stats(self, bs: bytes | bytearray) -> None:
        """Parse inverter status and electrical statistics."""
        data = {}
    ...
    def parse_load_info(self, bs: bytes | bytearray) -> None:
        """Parse inverter load measurements and status."""
        data = {}
